...
import (
	...
	sealed_secrets_v1alpha1 "github.com/devjoes/sealed-secrets/pkg/apis/sealed-secrets/v1alpha1"
	versioned "github.com/devjoes/sealed-secrets/pkg/client/clientset/versioned"
	internalinterfaces "github.com/devjoes/sealed-secrets/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/devjoes/sealed-secrets/pkg/client/listers/sealed-secrets/v1alpha1"
...
func (f *sealedSecretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sealed_secrets_v1alpha1.SealedSecret{}, f.defaultInformer)
}
