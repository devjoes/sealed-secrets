...
type Interface interface {
	...
	Bitnami() bitnamiv1alpha1.BitnamiV1alpha1Interface
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.bitnamiV1alpha1, err = bitnamiv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.bitnamiV1alpha1 = bitnamiv1alpha1.NewForConfigOrDie(c)
